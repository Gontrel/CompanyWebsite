...
const Webpage: React.FC = () => {
  ...
  const handleSubmit = async () => {
    if (email) {
      ...
      try {
        await addDoc(collection(handleFirestore(), "emails"), { email });
  ...
  useEffect(() => {
    if (email) {
      ...
      if (!emailRegex.test(email)) {
        setEmailErrorText("Email is invalid! Please enter a valid email.");
  ...
  return (
    <div className="webPage">
      <div>
        ...
        <button className="roundedButton">App coming soon 👀🔥</button>
